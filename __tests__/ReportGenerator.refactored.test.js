 ...
 *
 * ESTE É O ARQUIVO DE TESTE PARA O CÓDIGO REFATORADO.
 *
 * A única alteração é a linha do import, que agora aponta para
 * '../src/ReportGenerator.refactored.js'.
 *
 * Os testes em si permanecem INALTERADOS.
 */
...
describe('ReportGenerator (Rede de Segurança - REFATORADO)', () => {
  let generator;
